...
class Order(models.Model):
    """
    Saves order instance with bought games and shopper's details
    """
...
class OrderLineItem(models.Model):
    """
    Saves each game as a lineitem in Order instance.
    """
    ...
    def save(self, *args, **kwargs):
        """
        Overrides the original save method to set the line item total
